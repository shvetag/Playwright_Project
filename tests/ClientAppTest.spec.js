...
test.only('Login to Client App', async ({page})=> 
{
...
/*
test('Client App Registration', async ({page})=> 
    {
       ...
       await page.locator("#firstName").fill("Shveta");
       await page.locator("#lastName").fill("Gawas");
       await page.locator("#userEmail").fill("gshveta7@gmail.com");
       await page.locator("#userMobile").fill("0434641159");
       await page.locator("[value='Female']").click();
       await page.locator("#userPassword").fill("Parnika@0520");
       await page.locator("#confirmPassword").fill("Parnika@0520");
